...
Below data comes from following source:
...
# tidydata2.txt:
The data from above (tidydata.txt) were summarized by taking avaerage of each variable for each activity and each subject. Each data column contains average.